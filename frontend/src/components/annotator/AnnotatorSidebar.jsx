...
const NAV_ITEMS = [
  ...
  { id: 'images', label: 'Assigned Images', icon: Image, path: '/annotator/images' },
];
      ...
      >
        ...
        <div className="sidebar__footer">
          <div className="sidebar__status">
            <p className="sidebar__status-label">WORK STATUS</p>
            <div className="sidebar__status-row">
              <div className="sidebar__status-dot" aria-hidden="true" />
              <span className="sidebar__status-text">Ready to work</span>
            </div>
          </div>
        </div>
      </aside>
