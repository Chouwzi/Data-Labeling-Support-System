          ...
          <header className="login-header">
            <div className="logo-mark">
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="2" y="2" width="36" height="36" rx="8" fill="#6366f1" fillOpacity="0.15" stroke="#6366f1" strokeWidth="2"/>
                <circle cx="14" cy="14" r="4" fill="#6366f1"/>
                <circle cx="26" cy="14" r="4" fill="#818cf8"/>
                <circle cx="14" cy="26" r="4" fill="#818cf8"/>
          ...
          <form className="login-form" onSubmit={handleSubmit}>
            ...
            <div className="form-field">
              <div className="input-wrapper">
                ...
                >
                  {showPassword ? (
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="icon-hide">
                      <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/>
                      <line x1="1" y1="1" x2="23" y2="23"/>
                    </svg>
                  ) : (
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="icon-show">
